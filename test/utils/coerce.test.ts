...
describe(`integer, number`, () => {
  ...
  test(`calls constrain with all arguments`, () => {
    ...
    for (const schema of schemas) {
      ...
      expect(mocks.ensure).toHaveBeenLastCalledWith(0, true, schema);
    }
  });
});
...
describe(`boolean`, () => {
  ...
  test(`calls constrain with all arguments`, () => {
    ...
    expect(mocks.ensure).toHaveBeenLastCalledWith(true, true, schema);
  });
});
...
describe(`null`, () => {
  ...
  test(`calls constrain with all arguments`, () => {
    ...
    expect(mocks.ensure).toHaveBeenLastCalledWith(null, true, schema);
  });
});
...
describe(`array`, () => {
  ...
  test(`calls constrain with all arguments`, () => {
    ...
    expect(mocks.ensure).toHaveBeenLastCalledWith(item, true, schema);
  });
});
